...
- 다음 행동: **[DCR-006](./DCR-006-퇴원-비활성-학생과-반의-삭제.md) 사용자 승인 응답 처리.** 승인이면 요구사항(FR-05 상세·FR-07·AC-36)·설계(DES-04·REST)를 `v7`로 갱신하고 구현 작업을 계획에 넣어 진행한다. 그다음 [TASK-61 클라이언트 안내문](../../plan.md#task-61-클라이언트-안내문-작성)(사용자 지시로 다음 작업)
