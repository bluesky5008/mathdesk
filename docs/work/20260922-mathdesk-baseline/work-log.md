...
- 입력 문서와 기준선: [PLAN-mathdesk](../../plan.md), [REQ-mathdesk](../../requirements.md) `v11`, [DESIGN-mathdesk](../../design.md) `v11`, [결정 등록부](../../decisions.md)(ADR-001~012, DCR-001~010 모두 `approved`)
...
- 다음 행동: **[DCR-011](./DCR-011-강사의-담당-반-수정.md) 사용자 승인 응답 처리.** 승인이면 FR-07·역할별 권한·AC-40·권한 매트릭스를 `v12`로 갱신하고 TASK-67로 구현
