...
- 다음 행동: **[TASK-64 강사 계정 관리 화면](../../plan.md#task-64-강사-계정-관리-화면-fr-02) 구현 중** → [TASK-65 담당 강사 지정](../../plan.md#task-65-반-담당-강사-지정-fr-07) → [TASK-66 주간 시간표](../../plan.md#task-66-주간-시간표-dcr-008)(기준선 `v9`, 수업 길이 기본 120분)
