...
- 다음 행동: **[TASK-61 클라이언트 안내문 작성](../../plan.md#task-61-클라이언트-안내문-작성)**(사용자 지시로 다음 작업). 재료는 작업 기록의 사이클 3 계획·월 비용 산출(반 8개: LMS 월 약 20.4만~26.5만원)과 `ops/messaging-setup.md`. 착수 시 안내문의 형식·보관 위치를 사용자에게 확인한다
