...
- 현재 결론 또는 상태: 사이클 1(MVP) 완료(사용자 승인). 사이클 2 진행 중 — 2026-09-24 세션에서 마스터 데이터 수정(TASK-49~52), M5 성적 통계(TASK-24~26), 공통 기반(TASK-28), M6 시험지 분석(TASK-29~32), OMR 판독·검수(TASK-34·35)를 완료했다. 작업 53건 중 44건.
- 다음 행동: [TASK-36 채점 엔진과 문항별 통계](../../plan.md#task-36-채점-엔진과-문항별-통계). 상세는 [인계](#인계).
...
- 진행 중인 작업: [TASK-33 M7 OMR 채점](../../plan.md#task-33-m7-omr-채점) — 분해 3건 중 TASK-34·35 완료
- 마지막 완료 작업: [TASK-35 학생 매칭·검수·라벨 교정](../../plan.md#task-35-학생-매칭검수라벨-교정) (2026-09-24 11:54)
...
- 다음 작업: [TASK-36 채점 엔진과 문항별 통계](../../plan.md#task-36-채점-엔진과-문항별-통계), 또는 [TASK-27 M9 상담일지](../../plan.md#task-27-m9-상담일지)
...
- 완료된 항목: 기준선 v1~v6 승인, ADR-001~012, DCR-001~005, 사이클 1 전체(TASK-01~TASK-22), TASK-23, TASK-40~TASK-42, 시각 설계 TASK-44~TASK-48, 모바일 TASK-53, 마스터 데이터 수정 TASK-49~TASK-52, M5 통계 TASK-24~TASK-26, 공통 기반 TASK-28, M6 시험지 분석 TASK-29~TASK-32, OMR 판독·검수 TASK-34·35 — 작업 53건 중 44건
- 미완료 항목: TASK-27, TASK-33(TASK-36 남음), TASK-37~TASK-39, TASK-43
...
- 테스트 운영: `eb335e1`로 2026-09-24 재배포 완료. TASK-35 이후 커밋은 미배포 — 사용자 지시가 있을 때만 배포한다
...
- 다음 행동: **[TASK-36 채점 엔진과 문항별 통계](../../plan.md#task-36-채점-엔진과-문항별-통계).** 선행 테스트는 AC-25 후반부(교정 후 점수·정답률 갱신)와 재적용 멱등성. 먼저 [TASK-35 기록](#2026-09-24--task-35-학생-매칭검수라벨-교정-완료)의 "TASK-36에 넘기는 것" 3가지(`needs_review` 제외, 같은 학생 중복 매칭, `applied` 재교정)를 규칙으로 정한다. 정답표는 `exam.answer_key_odd/even`(TASK-32), 결과는 `exam_attempt`·`exam_answer`. 채점 결과 화면(문항별 정오답·오답 유형 탭)과 난이도 카드와 같은 언어의 시험 결과 카드 여부도 이 작업의 범위다. 짧게 끊고 싶으면 [TASK-27 M9 상담일지](../../plan.md#task-27-m9-상담일지)가 독립적이다
