...
- 다음 행동: **[TASK-62 학생·반 삭제](../../plan.md#task-62-학생반-삭제-dcr-006) 구현**(기준선 `v7`, 진행 중). 선행 테스트는 AC-36 ①~④·미리보기 건수·외래키 전수 분류. 그다음 [TASK-61 클라이언트 안내문](../../plan.md#task-61-클라이언트-안내문-작성)
