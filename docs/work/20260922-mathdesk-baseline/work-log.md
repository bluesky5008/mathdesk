...
- 다음 행동: **[DCR-008](./DCR-008-주간-시간표.md) 사용자 승인 응답 처리.** 승인이면 FR-42·AC-38·REST 2개를 `v9`로 갱신. 구현 순서는 [TASK-64 강사 계정 관리](../../plan.md#task-64-강사-계정-관리-화면-fr-02) → [TASK-65 담당 강사 지정](../../plan.md#task-65-반-담당-강사-지정-fr-07) → [TASK-66 주간 시간표](../../plan.md#task-66-주간-시간표-dcr-008). 64·65는 승인된 요구사항이라 DCR 결과와 무관하게 진행 가능
