...
└─ [ ] 사이클 3 — 운영 이관 (계획 2026-09-24) ......... in-progress (9/18)
   ├─ [ ] TASK-70 출결 잠금 알림 강화 ................ 경량, 다음 착수
   ├─ [ ] TASK-71 반 배정 시작일 선택 (FR-08) ........ 경량
...
flowchart TD
    ...
    C3 --> T70["TASK-70 출결 잠금 알림 강화"]:::todo
...
- 변경 대상: `pages/DailyPage.tsx`, `components/AttendanceButtons.tsx`(잠긴 칸 클릭 피드백 — `disabled`는 클릭 이벤트가 없으므로 `aria-disabled` 방식 검토)
- 의존성: 없음
