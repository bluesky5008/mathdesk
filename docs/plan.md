...
- 현재 결론 또는 상태: 작업 40건 중 TASK-02·TASK-03·TASK-04를 완료했다. TASK-01은 자식 2건(TASK-05·TASK-40)이 남아 진행 중이다.
- 다음 행동: [TASK-05 권한·캠퍼스 스코프 강제](#task-05-권한캠퍼스-스코프-강제)를 시작한다.
...
```text
mathdesk 구현 (기준선 v1, 작업 20260922-mathdesk-baseline)     in-progress (3/40)
│
├─ 사이클 1 — MVP (M0~M4) ........................... in-progress (3/23)
│  ├─ [▶] TASK-01 M0 기반 (분해 5, 3/5)
...
flowchart TD
    ...
    T01 --> T05["TASK-05 권한·캠퍼스 스코프"]:::active
