...
- 현재 결론 또는 상태: 작업 40건 중 TASK-02~TASK-05·TASK-07을 완료했다. TASK-01은 TASK-40(로그인 시도 제한)만 남아 있다.
- 다음 행동: [TASK-08 마스터 데이터 화면](#task-08-마스터-데이터-화면)을 시작한다. TASK-40은 임계값 확정 후 착수한다.
...
```text
mathdesk 구현 (기준선 v1, 작업 20260922-mathdesk-baseline)     in-progress (5/40)
│
├─ 사이클 1 — MVP (M0~M4) ........................... in-progress (5/23)
...
│  ├─ [▶] TASK-06 M1 학생/반 관리 (분해 2, 1/2) ...... depends: TASK-05
...
flowchart TD
    ...
    C1 --> T06["TASK-06 M1 학생/반 관리"]:::active
    T06 --> T07["TASK-07 마스터 데이터 API"]:::done
    T06 --> T08["TASK-08 마스터 데이터 화면"]:::active
