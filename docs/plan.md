...
│
└─ [ ] 사이클 3 — 운영 이관 (계획 2026-09-24) ......... in-progress (11/20)
   ├─ [ ] TASK-73 명단 다중 배정·반 옮기기 (FR-08) ... 배포됨, 사용자 확인 대기
   ├─ [ ] TASK-70 출결 잠금 알림 강화 ................ 배포됨, 사용자 육안 확인 대기
...
flowchart TD
    ...
    C3 --> T70["TASK-70 출결 잠금 알림 강화"]:::active
...
- 상태: in-progress — 구현·배포 완료(2026-09-25 00:46), 사용자 육안 확인 대기
- 상위: 없음
