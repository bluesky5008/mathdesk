...
│
└─ [ ] 사이클 3 — 운영 이관 (계획 2026-09-24) ......... in-progress (7/18)
   ├─ [ ] TASK-68 학생/반 관리 탭 분리 ............... 경량, 다음 착수
   ├─ [ ] TASK-69 빈 반 안내 (일일 입력) ............. depends: TASK-68
...
flowchart TD
    C3["사이클 3 — 운영 이관"]:::todo
    C3 --> T68["TASK-68 학생/반 관리 탭 분리"]:::todo
...
- 상태: pending
- 상위: 없음
- 목표: 상단 메뉴 "학생/반 관리" 안에 [학생]·[반] 하위 탭을 두고 하나씩 보여 준다. 기본은 학생 탭. 탭마다 주소(`/students`, `/classes`)를 두어 새로 고침·뒤로 가기에도 탭이 유지되고, 두 주소 모두 상단 메뉴가 선택 상태로 보인다.
