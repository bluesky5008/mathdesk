...
│
└─ [ ] 사이클 3 — 운영 이관 (계획 2026-09-24) ......... in-progress (1/9)
   ├─ [✓] TASK-62 학생·반 삭제 (DCR-006) ............. 2026-09-24 18:08
   ├─ [▶] TASK-61 클라이언트 안내문 작성 ............. 사용자 검토 대기
...
flowchart TD
    ...
    C3 --> T61["TASK-61 클라이언트 안내문"]:::active
...
- 상태: in-progress — 초안 작성 완료, 사용자 검토 대기(2026-09-24). 위치 [`docs/client/운영-이관-안내.md`](./client/운영-이관-안내.md)(사용자 지정: docs 하위, 형식 자유)
- 상위: 없음
