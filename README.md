...
기준선 `v1` 승인 후 [`docs/plan.md`](docs/plan.md)의 TASK-01~39로 구현 중이다. MVP(M0~M4: 인증·학생/반·일일 입력·대시보드·알림문자) 구현이 끝났다. 테스트 운영은 <https://mathdesk.yongs-wiki.com>에서 접근할 수 있다. 다음은 통합 검증(TASK-21).
